...
<title>Luyện bài tập đọc - Part 7</title>
...
<body>
	...
	<div class="container">
		...
		<div class="span9" style="text-align: center">
			<h2 style="font-weight: bold">LUYỆN ĐỌC PART 7</h2>
		...
		<div class="row">
			<div class="span9" style="text-align: center">
				...
				<div class="blog-post">
					...
					<p>Directions: In this part, you will read a selection of business letters. Each text is followed by several questions. Select the best answer for each question by clicking on the answer you want to choose.</p></div>	
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-footer">
								<input class="btn btn-danger" id="btnLamLai" type="button"
									value="Làm lại" /> <input class="btn btn-primary"
									id="btnXemGiaiThich" type="button" value="Xem Giải thích" />
			...
			<script src="<c:url value='/js/client/baiDoc/lamBaiDocPart7.js'/>"></script>
</body>
</html>