...
<title>Luyện bài tập nghe - Part 2</title>
...
<body>
	...
	<div class="container">
		...
		<div class="span9" style="text-align: center">
			<h2 style="font-weight: bold">LUYỆN NGHE PART 2</h2>
					...
					<div class="modal-content">
						...
						<div class="modal-footer">
							<input class="btn btn-danger" id="btnLamLai" type="button"
								value="Làm lại" /> <input class="btn btn-primary" id="btnXemGiaiThich"
								type="button" value="Xem Giải thích" />
		...
		<script src="<c:url value='/js/client/baiNghe/lamBaiNghePart2.js'/>"></script>
</body>
</html>